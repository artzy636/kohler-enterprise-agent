...
3. Grab a free Gemini API key from [aistudio.google.com](https://aistudio.google.com) — no card needed
4. Make a `.env` file in the project root:

GEMINI_API_KEY=your-key-here

5. Build the search indexes (only needs doing once, or again if you edit anything in `data/`):
